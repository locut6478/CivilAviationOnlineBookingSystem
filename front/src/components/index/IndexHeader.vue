<template>
  ...
  <div
      ...
      class="navbar">
    <div :style="{justifyContent:heads.headTitleStyle=='1'?'flex-start':'center'}" class="title-menu">
      <el-image v-if="heads.headTitleImg" :src="heads.headTitleImgUrl"
                ...
                class="title-img" fit="cover"></el-image>
      <div :style="{color:heads.headFontColor,fontSize:heads.headFontSize}" class="title-name">
        {{ this.$project.projectName }}
      </div>
    </div>
    <div class="right-menu">
      <div :style="{color:heads.headUserInfoFontColor,fontSize:heads.headUserInfoFontSize}" class="user-info">
      ...
      <div :style="{color:heads.headLogoutFontColor,fontSize:heads.headLogoutFontSize}" class="logout"
           @click="onLogout">退出登录
      </div>
    </div>
  </div>
...
export default {
  data() {
    return {
      ...
      user: {},
      heads: {
        "headLogoutFontHoverColor": "rgba(255, 215, 0, 1)",
        "headFontSize": "20px",
        "headUserInfoFontColor": "rgba(255, 255, 255, 1)",
        "headBoxShadow": "0px 0px 0px 0px rgba(36, 139, 146, 1)",
        "headTitleImgHeight": "44px",
        "headLogoutFontHoverBgColor": "rgba(36, 139, 146, 1)",
        ...
        "headBgColor": "linear-gradient(to right,var(--publicMainColor)  , var(--publicSubColor))",
