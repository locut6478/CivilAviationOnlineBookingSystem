  ...
  <div class="main-content">
    <el-dialog title="帖子回复详情" :visible.sync="forumReplyDialogVisible">
      ...
      <div class="demo-input-suffix">
        ...
        <el-input v-model="forumTitle" :disabled="true" placeholder="帖子标题" style="width: 80%"></el-input>
      </div>
      <div class="demo-input-suffix">
...
|| sessionTable == 'users')" type="danger" icon="el-icon-delete" size="mini" @click="deleteHandler(scope.row.id)">删除帖子
            </el-button>
          </template>
        </el-table-column>
      </el-table>
      ...
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" class="slt"
          ...
          <el-form-item :label="contents.inputTitle == 1 ? '帖子标题' : ''">
            <el-input prefix-icon="el-icon-search" v-model="searchForm.forumName" placeholder="帖子标题"
                      clearable></el-input>
          </el-form-item>
        ...
        <el-row class="ad"
          ...
          <el-form-item>
            ...
            <a style="text-decoration:none" class="el-button el-button--success"
               ...
               href="http://localhost:8080/mhwangshangdingpiao/upload/forumMuBan.xls"
            >批量导入论坛数据模板</a>
            &nbsp;
            <el-upload
                v-if="isAuth('forum','导入导出')"
            ...
            &nbsp;
            <!-- 导出excel -->
            <download-excel v-if="isAuth('forum','导入导出')" style="display: inline-block" class="export-excel-wrapper"
                            :data="dataList" :fields="json_fields" name="forum.xls">
              <!-- 导出excel -->
              <el-button
                  type="success"
                  icon="el-icon-download"
        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
          ...
          <el-table-column width="300" :align="contents.tableAlign"
            ...
            <template slot-scope="scope">
              ...
              <el-button v-if="isAuth('forum','查看')" type="success" icon="el-icon-tickets" size="mini"
                         @click="addOrUpdateHandler(scope.row.id,'info')">详情
              </el-button>
              <el-button v-if="isAuth('forum','查看')" type="primary" icon="el-icon-edit" size="mini"
                         @click="openReplyForum(scope.row.id,scope.row.forumName,scope.row.forumContent)">查看论坛回复
              </el-button>
              <el-button v-if="isAuth('forum','修改')" type="primary" icon="el-icon-edit" size="mini"
  ...
  methods: {
    ...
    forumReply() {
      ...
      let data = {
        "superIds": _this.superIds,
        "forumStateTypes": 2,
        "forumContent": _this.forumReplyContent,
        "forumPhoto": _this.forumReplyPhoto
      };
      _this.$http({
        url: `forum/save`,
        method: "post",
