  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item class="input" v-if="type!='info'" label="新闻标题" prop="newsName">
            <el-input v-model="ruleForm.newsName"
                      placeholder="新闻标题" clearable :readonly="ro.newsName"></el-input>
          </el-form-item>
          <div v-else-if="type=='info'">
            <el-form-item class="input" label="新闻标题" prop="newsName">
              <el-input v-model="ruleForm.newsName"
                        placeholder="新闻标题" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item class="select" v-if="type!='info'" label="新闻类型" prop="newsTypes">
            <el-select v-model="ruleForm.newsTypes" :disabled="ro.newsTypes" placeholder="请选择新闻类型">
              <el-option
        ...
        <el-col :span="12">
          <el-form-item class="upload" v-if="type!='info' && !ro.newsPhoto" label="新闻图片" prop="newsPhoto">
            <file-upload
                tip="点击上传新闻图片"
                action="file/upload"
                :limit="3"
          ...
          <div v-else>
            <el-form-item v-if="ruleForm.newsPhoto" label="新闻图片" prop="newsPhoto">
              <img style="margin-right:20px;" v-bind:key="index"
                   v-for="(item,index) in (ruleForm.newsPhoto || '').split(',')" :src="$base.url+item" width="100"
                   height="100">
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item class="date" v-if="type!='info'" label="新闻时间" prop="insertTime">
            <el-date-picker
              v-model="ruleForm.insertTime"
              type="datetime"
              placeholder="选择新闻时间"
              :readonly="ro.insertTime">
            </el-date-picker>
          </el-form-item>
          <div v-else-if="type=='info'">
            <el-form-item class="input" label="新闻时间" prop="insertTime">
              <el-input v-model="ruleForm.insertTime"
                        placeholder="新闻时间" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="24">
          <el-form-item v-if="type!='info' && !ro.newsContent" label="新闻详情" prop="newsContent">
          ...
          <div v-else-if="type=='info'">
            <el-form-item v-if="ruleForm.newsContent" label="新闻详情" prop="newsContent">
...
export default {
  ...
  created() {
    ...
    // 如果是新增，设置默认时间为当前时间
    if(!this.ruleForm.insertTime) {
      this.ruleForm.insertTime = new Date();
    }
    ...
    onSubmit() {
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          // 格式化日期时间
          if(this.ruleForm.insertTime) {
            this.ruleForm.insertTime = this.$moment(this.ruleForm.insertTime).format('YYYY-MM-DD HH:mm:ss');
          }
