        ...
        <el-col :span="12">
          <el-form-item class="input" v-if="type!='info'" label="数据类型编码" prop="codeIndex">
            <el-input v-model="ruleForm.codeIndex"
                      placeholder="数据类型编码" clearable :readonly="ro.codeIndex"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="数据类型编码" prop="codeIndex">
              <el-input v-model="ruleForm.codeIndex"
                        placeholder="数据类型编码" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" v-if="type!='info'" label="数据类型" prop="indexName">
            <el-input v-model="ruleForm.indexName"
                      placeholder="数据类型" clearable :readonly="ro.indexName"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="数据类型" prop="indexName">
              <el-input v-model="ruleForm.indexName"
                        placeholder="数据类型" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <!--<el-col :span="12">
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          ...
          ruleForm["dicCode"] = "chat_types";
          ruleForm["dicName"] = "数据类型";
          this.$http({
