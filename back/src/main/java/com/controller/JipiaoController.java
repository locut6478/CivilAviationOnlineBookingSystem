...
public class JipiaoController {
    ...
    */
    ...
    public R page(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        params.put("jipiaoDeleteStart",1);params.put("jipiaoDeleteEnd",1);
    ...
    */
    ...
    public R gexingtuijian(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        for(Integer type:typeList){
            Map<String, Object> params2 = new HashMap<>(params);params2.put("jipiaoTypes",type);
        ...
        if(returnJipiaoViewList.size()<limit){//返回数量还是小于要求数量
            ...
            for(JipiaoView jipiaoView:jipiaoViewList){
                ...
                for(JipiaoView returnJipiaoView:returnJipiaoViewList){
                    if(returnJipiaoView.getId().intValue() ==jipiaoView.getId().intValue()) addFlag=false;//返回的数据中已存在此商品
                }
                if(addFlag){
                    toAddNum=toAddNum-1;
