    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" class="slt"
          ...
          <el-form-item label="订单类型">
            <el-input prefix-icon="el-icon-search" v-model="searchForm.indexNameSearch" placeholder="订单类型"
                      clearable></el-input>
          </el-form-item>
          <el-form-item>
        ...
        <el-row class="ad"
          ...
          <el-form-item>
            <el-button
                v-if="isAuth('dictionaryJipiaoOrder','新增')"
                type="success"
                icon="el-icon-plus"
            ...
            <el-button
                v-if="isAuth('dictionaryJipiaoOrder','删除')"
      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                  ...
                  v-if="isAuth('dictionaryJipiaoOrder','查看')"
                  :data="dataList"
          ...
          <el-table-column width="300" :align="contents.tableAlign"
                           ...
                           label="操作">
            <template slot-scope="scope">
              <el-button v-if="isAuth('dictionaryJipiaoOrder','查看')" type="success" icon="el-icon-tickets" size="mini"
                         @click="addOrUpdateHandler(scope.row.id,'info')">详情
              </el-button>
              <el-button v-if="isAuth('dictionaryJipiaoOrder','修改')" type="primary" icon="el-icon-edit" size="mini"
                         @click="addOrUpdateHandler(scope.row.id)">修改
              </el-button>
              <el-button v-if="isAuth('dictionaryJipiaoOrder','删除')" type="danger" icon="el-icon-delete" size="mini"
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      //本表的
      params['dicCode'] = "jipiao_order_types"//编码名字
