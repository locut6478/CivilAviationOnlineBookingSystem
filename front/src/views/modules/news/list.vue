    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" class="slt"
          ...
          <el-form-item :label="contents.inputTitle == 1 ? '新闻标题' : ''">
            <el-input prefix-icon="el-icon-search" v-model="searchForm.newsName" placeholder="新闻标题"
                      clearable></el-input>
          </el-form-item>
        ...
        <el-row class="ad"
          ...
          <el-form-item>
            ...
            <a style="text-decoration:none" class="el-button el-button--success"
               ...
               href="http://localhost:8080/mhwangshangdingpiao/upload/newsMuBan.xls"
            >批量导入民航新闻数据模板</a>
            &nbsp;
            <el-upload
                v-if="isAuth('news','导入导出')"
            ...
            &nbsp;
            <!-- 导出excel -->
            <download-excel v-if="isAuth('news','导入导出')" style="display: inline-block" class="export-excel-wrapper"
                            :data="dataList" :fields="json_fields" name="news.xls">
              <!-- 导出excel -->
              <el-button
                  type="success"
                  icon="el-icon-download"
        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
          ...
          <el-table-column width="300" :align="contents.tableAlign"
            ...
            <template slot-scope="scope">
              ...
              <el-button v-if="isAuth('news','查看')" type="success" icon="el-icon-tickets" size="mini"
                         @click="addOrUpdateHandler(scope.row.id,'info')">详情
              </el-button>
              <el-button v-if="isAuth('news','修改')" type="primary" icon="el-icon-edit" size="mini"
                         @click="addOrUpdateHandler(scope.row.id)">修改
              </el-button>
              <el-button v-if="isAuth('news','删除')" type="danger" icon="el-icon-delete" size="mini"
