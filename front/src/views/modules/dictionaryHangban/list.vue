    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" class="slt"
          ...
          <el-form-item label="航班状态">
            <el-input prefix-icon="el-icon-search" v-model="searchForm.indexNameSearch" placeholder="航班状态"
                      clearable></el-input>
          </el-form-item>
          <el-form-item>
        ...
        <el-row class="ad"
          ...
          <el-form-item>
            <el-button
                v-if="isAuth('dictionaryHangban','新增')"
                type="success"
                icon="el-icon-plus"
            ...
            <el-button
                v-if="isAuth('dictionaryHangban','删除')"
      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                  ...
                  v-if="isAuth('dictionaryHangban','查看')"
                  :data="dataList"
          ...
          <el-table-column width="300" :align="contents.tableAlign"
                           ...
                           label="操作">
            <template slot-scope="scope">
              <el-button v-if="isAuth('dictionaryHangban','查看')" type="success" icon="el-icon-tickets" size="mini"
                         @click="addOrUpdateHandler(scope.row.id,'info')">详情
              </el-button>
              <el-button v-if="isAuth('dictionaryHangban','修改')" type="primary" icon="el-icon-edit" size="mini"
                         @click="addOrUpdateHandler(scope.row.id)">修改
              </el-button>
              <el-button v-if="isAuth('dictionaryHangban','删除')" type="danger" icon="el-icon-delete" size="mini"
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      //本表的
      params['dicCode'] = "hangban_types"//编码名字
      params['dicName'] = "航班状态",//汉字名字
          this.$http({
            url: "dictionary/page",
            method: "get",
            params: params
